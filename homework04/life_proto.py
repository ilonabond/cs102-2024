...
class GameOfLife:
    ...
    def get_next_generation(self) -> Grid:
        ...
        for row_idx in range(self.cell_height):
            for col_idx in range(self.cell_width):
                live_neighbours = sum(1 for neighbour in self.get_neighbours((row_idx, col_idx)) if neighbour == 1)
